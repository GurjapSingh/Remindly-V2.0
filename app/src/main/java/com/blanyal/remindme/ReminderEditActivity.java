...
public class ReminderEditActivity extends AppCompatActivity implements
    ...
    private static final String KEY_TYPE = "reminder_type";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDate = mReceivedReminder.getEventDate();
        mTime = mReceivedReminder.getEventTime();
        ...
        mPriority = mReceivedReminder.getPriority();
        mType = mReceivedReminder.getType();
        //LOCATION SERVICES
        placename = mReceivedReminder.getName();
        ...
        if (savedInstanceState != null) {
            ...
            String savedPriorityType = savedInstanceState.getString(KEY_PRIORITY);
            mPriorityTypeText.setText(savedPriorityType);
            mPriority = savedPriorityType;

            String savedReminderType = savedInstanceState.getString(KEY_TYPE);
            mReminderTypeText.setText(savedReminderType);
            mType = savedReminderType;
...
//    }
    ...
    public void selectReminderLocation(View v){
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, ReminderAddActivity.REQUEST_PERMISSION_RESULT_CODE);
        }
        ...
        try{
            ...
            startActivityForResult(intent, ReminderAddActivity.PLACE_PICKER_REQUEST);
        } catch (GooglePlayServicesRepairableException e) {
            e.printStackTrace();
            Log.d("placepicker:","selectReminderLocation error");
...
//    }
    ...
    public void updateReminder() {
        ...
        mReceivedReminder.setPriority(mPriority);
        mReceivedReminder.setType(mType);;
        mReceivedReminder.setName(placename);
        mReceivedReminder.setAddress(address);
        DecimalFormat df = new DecimalFormat("#.##");
        mReceivedReminder.setLongitude(df.format(latitude));
        mReceivedReminder.setLatitude(df.format(longtitude));
        ...
        // Create snackbar to confirm update
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.discard_reminder:
                Intent returnIntent = new Intent();
                returnIntent.putExtra("result", "Changes Discarded");
                setResult(RESULT_OK, returnIntent);
                onBackPressed();
                return true;
