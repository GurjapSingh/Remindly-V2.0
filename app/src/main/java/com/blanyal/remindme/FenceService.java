...
public class FenceService extends BroadcastReceiver{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (TextUtils.equals(fenceState.getFenceKey(), MainActivity.LOCATION_FENCE_KEY)) {
            switch(fenceState.getCurrentState()) {
                case FenceState.TRUE:
                    ...
                    LocationService.mAddGeoFence.removeLocationFence(MainActivity.LOCATION_FENCE_KEY,context,LocationService.mGoogleApiClient);
